...
private:
    ...
    double** initAMatrice(const unsigned n, const unsigned m);
    ...
    void alpha(double **result, int* sequence, const unsigned nbEmission, double* pC);
    void beta(double **result, int* sequence, const unsigned nbEmission, double* pC);
    double computeAlpha2(double** alpha, int* sequence, const unsigned nbEmission);
public:
    double emissionProba;
    ...
    double* nextEmissionDistribution(int *sequence, const unsigned nbEmission);
